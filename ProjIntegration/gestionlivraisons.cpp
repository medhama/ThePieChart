    ...
    QDialog(parent),ui(new Ui::GestionLivraisons)
{
    ...
    musicClic->setMedia(QUrl("C:/Users/Hamadi/Desktop/C++/ThePieChartIntegration/ThePieChart/ProjIntegration/Music/click2.wav"));
    musicClic->setVolume(10);
    //ui->label_40->setText("10");
    musica->setMedia(QUrl("C:/Users/Hamadi/Desktop/C++/ThePieChartIntegration/ThePieChart/ProjIntegration/Music/piano.mp3"));
    musica->setVolume(20);
