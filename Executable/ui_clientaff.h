...
"    border-radius: 5;"));
        ...
        pushButton_8 = new QPushButton(horizontalLayoutWidget_16);
        ...
        currentTime = new QLabel(tab_4);
        currentTime->setObjectName(QStringLiteral("currentTime"));
        currentTime->setGeometry(QRect(650, 10, 121, 41));
        currentTime->setStyleSheet(QLatin1String("font: 16pt;\n"
""));
    ...
    void retranslateUi(QDialog *ClientAff)
    {
        ...
        CinLabel->setText(QApplication::translate("ClientAff", "Cin", Q_NULLPTR));
        NomLabel->setText(QApplication::translate("ClientAff", "Nom", Q_NULLPTR));
        PrenomLabel->setText(QApplication::translate("ClientAff", "Prenom", Q_NULLPTR));
        ...
        pushButton_8->setText(QApplication::translate("ClientAff", "Export ingredients", Q_NULLPTR));
        ...
        currentTime->setText(QApplication::translate("ClientAff", "00:00:00", Q_NULLPTR));
